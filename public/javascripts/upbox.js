(function($){
  ...
  $.fn.upBox = function(options) {  
    ...
    function fileHandler(dom, file, img) {
            //读取文件
...
　　　　　　      //发送成功
                  if ( xmlHttpRequest.readyState == 4 && xmlHttpRequest.status == 200 ) {
                    ...
                    dom.append("<img src = '" + src + "' width = '200' height = '200' id = 'imgPreview'><a href = '#' class = 'removePic'><span class='glyphicon glyphicon-remove'></span></a>");
